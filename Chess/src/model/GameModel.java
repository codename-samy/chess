...
public class GameModel {
  ...
  public ArrayList<int[]> getPossibleMoves(int row, int col) {
    ...
    for (ChessBox possibleBox : chessBox
      .getOccupyingPiece()
  ...
  public boolean notInTurnBox(int row, int col) {
    ...
    if (pieceColor.equalsIgnoreCase(playerColor)) return false;
    return true;
  }
  ...
  public int getPlayerScore(String playerColor) {
    if (playerColor.equalsIgnoreCase("black")) return gameState
      .getBlackPlayer()
      .getScore(); else return gameState.getWhitePlayer().getScore();
  }
  ...
  public void incrementPlayerScore(String playerColor) {
    if (playerColor.equalsIgnoreCase("black")) gameState
      .getBlackPlayer()
      .incrementScore(); else gameState.getWhitePlayer().incrementScore();
  }
